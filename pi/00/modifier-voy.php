			...
			<div class="contact-page-form-wrapper">
				<form action="modifier-voy1.php" method="post">
					<div class="row">
								...
								<div class="col-md-6">
							<input type="text" placeholder="Depart" name="depart" value="<?php echo $_GET['depart']; ?>">
						</div>
						<div class="col-md-6">
							<input type="text" placeholder="Destination" name="destination" value="<?php echo $_GET['destination']; ?>">
						</div>
												<div class="col-md-6">
Date sortie
						</div>
