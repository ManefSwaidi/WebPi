...
<!-- Mirrored from risingtheme.com/html/rokon-demo/rokon/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 23:34:16 GMT -->
<head>
  <meta charset="utf-8">
  <title>Rokon - Product Details</title>
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        ...
                                        <li class="header__mega--menu__li fullscreen__style d-flex">
                                            <a class="header__mega--menu__banner" href="shop.html"><img class="header__mega--menu__banner--img" src="assets1/img/other/mega-menu-banner.webp" alt="banner-menu"></a>
                                            <a class="header__mega--menu__banner" href="shop.html"><img class="header__mega--menu__banner--img" src="assets1/img/other/mega-menu-banner2.webp" alt="banner-menu"></a>
                                        </li>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets1/img/product/big-product1.webp"><img class="product__media--preview__items--img" src="assets1/img/product/big-product1.webp" alt="product-media-img"></a>
                                                <div class="product__badge">
                                                    <span class="product__badge--items sale">New</span>
                                                </div>
                                                <div class="product__media--view__icon">
                                                    <a class="product__media--view__icon--link glightbox" href="assets1/img/product/big-product1.webp" data-gallery="product-media-preview">
                        ...
                        <div class="product__details--info">
                            <form action="#">
                                ...
                                <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img" src="assets1/img/other/safe-checkout.webp" alt="Payment Image">
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="product__tab--content">
                                        ...
                                        <div class="product__tab--content__step style2 d-flex align-items-center mb-30">
                                            <div class="product__tab--content__banner">
                                                <img class="product__tab--content__banner--img display-block" src="assets1/img/other/drone-image2.webp" alt="banner-img">
                                            </div>
                                        ...
                                        <div class="reviews__comment--area">
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="assets1/img/other/comment-thumb1.webp" alt="comment-thumb">
                                                </div>
                                            ...
                                            <div class="reviews__comment--list margin__left d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="assets1/img/other/comment-thumb2.webp" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                            ...
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="assets1/img/other/comment-thumb3.webp" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="assets1/img/product/small-product1.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red6" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="assets1/img/product/small-product2.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red7" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="assets1/img/product/small-product3.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red8" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="assets1/img/product/small-product4.webp" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
...
<!-- Mirrored from risingtheme.com/html/rokon-demo/rokon/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 23:34:17 GMT -->
</html>