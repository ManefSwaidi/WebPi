...
<td><a href="modifier-voy.php?id_voy=<?php echo $row['id_heb']; ?>&titre=<?php echo $row['titre']; ?>&date_dispo=<?php echo $row['date_dispo']; ?>&date_nondispo=<?php echo $row['date_nondispo']; ?>&prix=<?php echo $row['prix']; ?>&description=<?php echo $row['description']; ?>">Modifier</a></td>
<td><a href="supprimer-resv.php?id_res=<?php echo $row['id_res']; ?>">Supprimer</a></td>
