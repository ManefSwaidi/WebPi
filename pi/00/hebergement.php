                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading">Interface</div>
                            ...
                            <div class="collapse" id="collapseIbergement" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="hebergement.php">Ajout </a>
                                    <a class="nav-link" href="reservation_hebergement.php">Reservation</a>
                                                                        <a class="nav-link" href="affichehebergement.php">Affiche</a>
...
<section id="contact-page-form" class="contact-page-form-section">
        <div class="container">
            ...
            <div class="contact-page-form-wrapper">
                <form action="Controller/ajoutHebergement.php" method="post"  enctype="multipart/form-data">
                    <div class="row">                       
                                <div class="col-md-6">
...
Date disponible
  ...
  <input type="datetime-local" id="date_nondispo" name="date_nondispo">
                        ...
                        <div class="col-md-5">
                            <input type="file" placeholder="Image" id="image" name="file">
                        </div>
                        <div class="col-md-12">
