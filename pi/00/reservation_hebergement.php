<?php
  ...
  $sql = "SELECT * FROM reservationheb";
                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading">Interface</div>
                            ...
                            <div class="collapse" id="collapseVoyages" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="voyage.php">Ajout</a>
...
<td><a href="modifier-heb.php?id_heb=<?php echo $row['id_heb']; ?>&titre=<?php echo $row['titre']; ?>&date_dispo=<?php echo $row['date_dispo']; ?>&date_nondispo=<?php echo $row['date_nondispo']; ?>&prix=<?php echo $row['prix']; ?>&description=<?php echo $row['description']; ?>">Modifier</a></td>
<td><a href="supprimer-resh.php?id_res=<?php echo $row['id_res']; ?>">Supprimer</a></td>
