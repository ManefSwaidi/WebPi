...
<head>
  <meta charset="utf-8">
  <title>Miracle - Liste Hebergement </title>
                    ...
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="blog.html">Travel  </a>
                                    
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link " href="#">Reclamations </a>
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content">
                            <h1 class="breadcrumb__content--title mb-10">Hebergement</h1>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        ...
                        <form class="widget__search--form" action="">
                    <label>
                        <input class="widget__search--form__input border-0" name="titre" placeholder="Search by" type="text">
                    </label>
                    <button class="widget__search--form__btn"  type="submit" aria-label="search button">
                ...
                <br>
               <a class="price__filter--btn primary__btn" href="shop-listh.php">Clear</a>
<br>
...
if (isset($_GET['titre'])){
    ...
    $sql = "SELECT * FROM Hebergement WHERE titre ='$tit'";
                                     ...
                                     <div class="col mb-30">
                                                ...
                                                <article class=" product__card product__card--list d-flex">
                                                    ...
                                                    <div class="product__card--content product__card--list__content">
                                                        <span class="product__card--meta__tag">Hebergement</span>
                                                        <h3 class="product__card--title"><a href="product-details.html"><?php echo htmlspecialchars($row['titre']); ?> </a></h3>
                                                        <div class="product__card--price">
                                                        ...
                                                        <p class="product__list--items__content--desc d-lg-none mb-5">Date dispo:&nbsp &nbsp <?php echo htmlspecialchars($row['date_dispo']); ?></p>
                                                        <p class="product__list--items__content--desc d-lg-none mb-5">Date non dispo:&nbsp &nbsp   <?php echo htmlspecialchars($row['date_nondispo']); ?></p>

                                                        <a class="product__card--btn primary__btn" target="_blank" href="checkouth.php?id_heb=<?php echo $row['id_heb']; ?>&titre=<?php echo $row['titre']; ?>&file=<?php echo $row['file']; ?>&prix=<?php echo $row['prix'];?> &date_dispo=<?php echo $row['date_dispo'];?>&date_nondispo=<?php echo $row['date_nondispo'];?> &description=<?php echo $row['description'];?>">Reserver</a>
                                                    </div>
                                                </article>
                                                </div>
     <?php endwhile; ?>
