...
<!-- Mirrored from risingtheme.com/html/rokon-demo/rokon/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 23:34:49 GMT -->
<head>
  <meta charset="utf-8">
  <title>Rokon - Checkout</title>
                ...
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    <ul class="header__contact--info d-flex align-items-center">
                        ...
                        <li class="header__contact--info__list text-white">
                            ...
                            <a href="miracle@esprit.tn">miracle@esprit.tn</a>
                        </li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        <div class="main checkout__mian">
                            <form  method="POST" action="Controller/ajoutreservationvoy.php?id_voy=<?php echo htmlspecialchars($_GET['id_voy']); ?>">
...
?> 
                    <div class="col-lg-5 col-md-6">
                        <aside class="checkout__sidebar sidebar border-radius-10">
                            <h2 class="checkout__order--summary__title text-center mb-15">Votre reservation</h2>
                                            ...
                                            <td class="cart__table--body__list">
                                              ...
                                              <?php  echo " <img class='display-block' src='./Controller/upload/".$_GET['file']."'";  ?>
                                                    ...
                                                    <div class="product__description">
                                                        <h4 class="product__description--name"><a href="product-details.html"><?php echo htmlspecialchars($_GET['id_voy']); ?></a></h4>
                                        
                                                        <span class="product__description--variant"><?php echo htmlspecialchars($_GET['description']); ?></span>
                                                        <br>
                                                        <span class="product__description--variant"><?php echo htmlspecialchars($_GET['date_sortie']); ?></span>
                                                        <br>
                                                        <span class="product__description--variant"><?php echo htmlspecialchars($_GET['date_retour']); ?></span>
                            ...
                            <a class="checkout__now--btn primary__btn" target="_blank" href="controller/upload/pdf1.php?id_voy=<?php echo $_GET['id_voy']; ?>&depart=<?php echo $_GET['depart']; ?>&file=<?php echo $_GET['file']; ?>&prix=<?php echo $_GET['prix'];?> &destination=<?php echo $_GET['destination'];?>&date_sortie=<?php echo $_GET['date_sortie'];?>&date_retour=<?php echo $_GET['date_retour'];?> &description=<?php echo $_GET['description'];?> ">Telecharger pdf</a>
                        </aside>
                    </div>
