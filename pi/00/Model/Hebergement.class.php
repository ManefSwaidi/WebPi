...
include('../includes/connect_db.php');
		...
		$req = $bdd->exec("INSERT INTO `hebergement`(`titre`, `date_dispo`, `date_nondispo`, `prix`, `file`, `description`) VALUES ('$this->titre','$this->date_dispo','$this->date_nondispo','$this->prix','$name','$this->description')");
