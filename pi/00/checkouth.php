                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        <div class="main checkout__mian">
                            <form  method="POST" action="Controller/ajoutreservationheb.php?id_heb=<?php echo htmlspecialchars($_GET['id_heb']); ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-20">
                                                <div class="checkout__input--list">
                                                    ...
                                                    <input class="checkout__input--field border-radius-5" placeholder="Num tel" id="num_tel" name="num_tel" type="number"  pattern="\d{8}">
                                                </div>
                                            </div>
...
?> 
                    <div class="col-lg-5 col-md-6">
                        <aside class="checkout__sidebar sidebar border-radius-10">
                            ...
                            <a class="checkout__now--btn primary__btn" target="_blank" href="controller/upload/pdf.php?id_heb=<?php echo $_GET['id_heb']; ?>&titre=<?php echo $_GET['titre']; ?>&file=<?php echo $_GET['file']; ?>&prix=<?php echo $_GET['prix'];?> &date_dispo=<?php echo $_GET['date_dispo'];?>&date_nondispo=<?php echo $_GET['date_nondispo'];?> &description=<?php echo $_GET['description'];?> ">Telecharger pdf</a>
                        </aside>
                    </div>
