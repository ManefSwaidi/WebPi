...
include('../includes/connect_db.php');
		...
		$req = $bdd->exec("INSERT INTO `equipee`(`depart`, `destination`, `date_sortie`, `date_retour`, `prix`, `description`) VALUES ('$this->depart','$this->destination','$this->date_sortie','$this->date_retour','$this->prix','$this->description')");
