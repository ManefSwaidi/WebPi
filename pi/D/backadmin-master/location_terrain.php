        ...
        <div id="layoutSidenav">
                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading">Interface</div>
                            ...
                            <div class="collapse" id="collapseFootball" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="Terrain.php">Terrain</a>
                                    <a class="nav-link" href="location_terrain.php">Reservation Terrain</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                   ...
                   <div class="container">
                   <h2> CRUD de equipeFoot</h2>
                   <form>
                  
                   <div class="mb-3">
    <label >nom Terrain</label>
    <input type="text" class="form-control"
    placeholder="saisir le nom de votre terrain" name="titre">
  </div>
  <div class="mb-3">
    <label >Nom de propriétaire</label>
    <input type="text" class="form-control"
    placeholder="saisir votre nom" name="image">
   
  </div>
  <div class="mb-3">
    <label >Debut reservation</label>
    <input type="datetime-local" class="form-control"
    placeholder="Date debut réservation " name="date_dispo">
  </div>
  <div class="mb-3">
    <label >Fin Rerservation</label>
    <input type="datetime-local" class="form-control"
    placeholder="Date fin réservation " name="date_nondispo">
  </div>
  <div class="mb-3">
    <label >Prix Par Personne </label>
    <input type="text" class="form-control"
    placeholder="saisir prix par personne" name="prix">
  </div>
  <div class="mb-3">
