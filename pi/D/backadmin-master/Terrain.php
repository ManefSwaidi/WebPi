...
<html lang="en">
    ...
    placeholder="saisir le nom de votre equipe" name="depart">
  </div>
  <div class="mb-3">
    <label >Nom de Reservation</label>
    <input type="text" class="form-control"
    placeholder="saisir le nom de reservation" name="destination">
   
  </div>
  <div class="mb-3">
    <label >Debut reservation</label>
    <input type="datetime-local" class="form-control"
    placeholder="Date debut réservation " name="date_sortie">
  </div>
  <div class="mb-3">
    <label >Fin Rerservation</label>
    <input type="datetime-local" class="form-control"
    placeholder="Date fin réservation " name="date_retour">
  </div>
  <div class="mb-3">
    <label >Membres </label>
    <input type="text" class="form-control"
    placeholder="saisir les membres de equipe" name="prix">
  </div>
  <div class="mb-3">
