		...
		<div class="container">
			...
			<div class="contact-page-form-wrapper">
				<form action="Controller/ajoutHebergement.php" method="post">
					<div class="row">
								<div class="col-md-6">
							<input type="text" placeholder="Nom De Terrain" value="<?php echo $_GET['titre']; ?>" name="titre">
						</div>
						<div class="col-md-6">
						</div>
												<div class="col-md-6">
Date Disponible
  ...
  <input type="datetime-local" id="date_nondispo" name="date_nondispo" value="<?php echo $_GET['date_nondispo']; ?>">
						...
						<div class="col-md-4">
							<input type="text" placeholder="Prix Par Personne(Dt)" name="prix"value="<?php echo $_GET['prix']; ?>">
						</div>
						<div class="col-md-5">
							<input type="file" placeholder="Image" name="image">
						</div>
						<div class="col-md-12">
							<textarea  placeholder="Description De Terrain" name="description"  ><?php echo $_GET['description']; ?></textarea>
						</div>
