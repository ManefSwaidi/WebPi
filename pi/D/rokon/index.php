...
<!-- Mirrored from risingtheme.com/html/rokon-demo/rokon/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 23:34:17 GMT -->
<head>
  <meta charset="utf-8">
                    ...
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="../../00/shop-listv.php">Travel </a>  
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="../../00/shop-listh.php">Accomodation  </a>
                            ...
                            <div class="hero__slider--activation swiper">
                                <div class="hero__slider--wrapper swiper-wrapper">
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="assets/img/slider/terrain2.png" alt="slider img">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Les Terrain Récent </h2>
                                                <p class="slider__content--desc d-sm-2-none">Découvrez Avec Nous Les Nouveauté Des Terrains.</p>  
                                                <div class="slider__content--footer d-flex align-items-center justify-content-center">
                                                    <a class="slider__content--btn primary__btn" href="../ADDequipe.php">Réservez1 Maintenant</a>
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="assets/img/slider/terr.jpg" alt="slider img">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Les Terrain Récent </h2>
                                                <p class="slider__content--desc d-sm-2-none">Découvrez Avec Nous Les Nouveauté Des Terrains.</p>  
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="assets/img/slider/terrain3.png" alt="slider img">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Les Terrain Récent </h2>
                                                <p class="slider__content--desc d-sm-2-none">Découvrez Avec Nous Les Nouveauté Des Terrains.</p>  
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="assets/img/slider/terrain.webp.png" alt="slider img">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Les Terrain Récent </h2>
                                                <p class="slider__content--desc d-sm-2-none">Découvrez Avec Nous Les Nouveauté Des Terrains.</p>  
                                                <div class="slider__content--footer d-flex align-items-center justify-content-center">
                                                    <a class="slider__content--btn primary__btn" href="shop.html"></a>
                                                    <div class="bideo__play slider__play--bideo">
                                                        <a class="bideo__play--icon glightbox" href="https://vimeo.com/115041822" data-gallery="video">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 31 37">
                                                                <path  data-name="Polygon 1" d="M16.783,2.878a2,2,0,0,1,3.435,0l14.977,25.1A2,2,0,0,1,33.477,31H3.523a2,2,0,0,1-1.717-3.025Z" transform="translate(31) rotate(90)" fill="currentColor"></path>
                ...
                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                        ...
                        <div class="about__content">
                            ...
                            <div class="about__content--step mb-25">
                                <p class="about__content--desc mb-20">Beyond more stoic this along goodness this sed wow manatee mongos 
                                    ...
                                    wasteful telling spransac coldly spokeles.</p>
                                <ul class="mb-20">
                                    <li class="about__content--desc__list">Beyond Fileds is an to be contre unmanned aerial.</li>
                                    <li class="about__content--desc__list">With various equipment including tho Fields.</li>
                                </ul>
                    ...
                    <div class="col">
                        <div class="about__thumbnail">
                            <img class="display-block" src="assets/img/other/nvterrain.jpg" alt="about-thumb">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="blog__section--inner blog__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img class="blog__card--thumbnail__img display-block" src="assets/img/blog/enfant.jpg" alt="blog-img"></a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img class="blog__card--thumbnail__img display-block" src="assets/img/blog/tunisie.jpg" alt="blog-img"></a>
                                </div>
                                <div class="blog__card--content">
                                    <ul class="blog__card--meta d-flex justify-content-center">
                                        <li class="blog__card--meta__text text__secondary">
    ...
    <div class="container">
        <div class="main__footer section--padding">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Our Maps <button class="footer__widget--button" aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                            </svg>
                        </h2>
                        <div class="footer__newsletter footer__widget--inner">
                            <iframe class="footer__contact--map__frame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3190.6867350172597!2d10.187604215225559!3d36.89784177992853!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12e2cb7454c6ed51%3A0x683b3ab5565cd357!2sESPRIT!5e0!3m2!1sen!2sbd!4v1651002913012!5m2!1sen!2sbd" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from risingtheme.com/html/rokon-demo/rokon/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 23:34:26 GMT -->
</html>