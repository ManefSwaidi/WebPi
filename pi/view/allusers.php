...
<?php
     ...
     if(isset($_GET['tri'])){
     $users= $controleur->triuser();
 }
     else{
    if(isset($_GET['recherche'])){
     $users= $controleur->rechercheuser($_GET['recherche']);
 }
     else{
          $users= $controleur->getusers();
...
<div>
    <form name="ff" method="post" action="rechercherUser.php">

        <?php
 if(isset($_GET['recherche'])){
echo '<input type="text" name="recherche" value="'.$_GET['recherche'].'">';
 }else{
    ...
    <input type="submit" value="recherche"  >
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table-dark table-striped" id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Last name</th>
    ...
    foreach ($users as $u) {
     echo '<tr>';
      echo  '<th>'.$u[1].' </th>';
            echo    '<th>'.$u[2].' </th>';
                  echo  '<th>'.$u[3].' </th>';
                  echo '<th> <a style="margin-left:50px; margin-right:30px" href="edituser.php?id='.$u[0].'"> <i class="fa-solid fa-user-pen"></i>  </a> <a href="deleteuser.php?id='.$u[0].'" onclick="return confirm(\'Are you sure?\')"> <i class="fa-solid fa-trash-can"></i> </a>   </th>';
                  echo '</tr>';
