				...
				<div class="col-lg-5 mx-auto">
					<div class="ts-grid-box">
						<div class="login-page">
							<h3 class="log-sign-title text-center mb-25">Please Log In, or <a href="inscription.php">Sign Up</a></h3>
							...
							<form role="form" method="post" action="loginsubmit.php">
								<div class="form-group">
								<label for="inputUsernameEmail">Username or email</label>
								<input type="email" class="form-control" name="email">
								</div>
								<div class="form-group">
								<a class="pull-right" href="forgetpass.php">Forgot password?</a>
