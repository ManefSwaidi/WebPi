...
<body class="body-color">
      ...
      <div class="row">
        <div class="col-lg-5 mx-auto">
          <div class="ts-grid-box">
              ...
              <form role="form" method="post" action="recsubmit.php">
                <h1 style="text-align:center;">Welcome to our Help Center</h1>
  ...
  <textarea class="form-control" placeholder="Problem" id="floatingTextarea2"  style="height: 100px; resize:none" name="problem"></textarea>
  <label for="floatingTextarea2"></label>
</div>
  <div class="mb-3 form-check my-5">

  </div>
  <button type="submit" class="btn btn-primary">Submit</button>
<a href="mesreclamations.php" class="btn btn-success">  reclamations </a>
