...
<!-- Mirrored from demo.themewinter.com/html/vinazine/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Apr 2022 22:45:55 GMT -->
<head>
    <!-- Basic Page Needs =====================================-->
    <meta charset="utf-8">
...
<body class="body-color">
            ...
            <div class="row">
                <div class="col-lg-5 mx-auto">
                    ...
                    <div class="ts-grid-box">
                        <div class="reg-page">
                            <h3 class="log-sign-title mb-25">Join Us or <a href="login.php"> Log in </a></h3>
                            <form id="forr" method="post" action="inscriptionsubmit.php">
                                <div id="error"></div>
                                <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="pass" class="form-control" type="password" placeholder="Enter your password" name="password" autocomplete="off"  aria-describedby="passwordHelpBlock" required onmousemove ="verifpass()">
  ...
  Your password must be 8-20 characters long, contain letters and numbers, and must not contain spaces, special characters, or emoji.
                                ...
                                <div class="form-group">
                                    <button id="btnsub" type="submit" class="btn btn-primary btn-block"> Sign Up  </button>
